...
public class  GiftVideoView extends GLTextureView {
    ...
    private AlphaModel alphaModel=AlphaModel.TOP_TO_ALPHA_BOTTOM;
    ...
    private void obtainRendererOptions(AttributeSet attrs) {
        if (attrs != null) {
            ...
            String mode=arr.getString(R.styleable.GiftVideoView_alphaModel);
            if(!TextUtils.isEmpty(mode)){
                switch (mode){
                    case "0":
                        alphaModel=AlphaModel.TOP_TO_ALPHA_BOTTOM;
                        break;
                    case"1":
                        alphaModel=AlphaModel.LEFT_TO_ALPHA_RIGHT;
                        break;
                    default:
                        break;
                }
    ...
    private void init() {
        ...
        renderer = new GiftRenderer(alphaModel);
    ...
    public void reset() {
        ...
        getHandler().removeCallbacks(hideViewRunnable);
    }
        ...
        if (mediaPlayer != null && (state == PlayerState.NOT_PREPARED
            ...
            mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                ...
                public void onPrepared(MediaPlayer mp) {
                    ...
                    //播放完成后，隐藏视图
                    hideViewRunnable=new HideViewRunanble();
                    int s=mediaPlayer.getDuration();
                    getHandler().postDelayed(hideViewRunnable,s);
    ...
    class  HideViewRunanble implements  Runnable{
